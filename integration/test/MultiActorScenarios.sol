...
// contract MultiActorScenarios is BaseScenario, TestUtils {
...
//     */
//     assertGt(cashflows[1], 0, "1");
//     assertAlmostEq(cashflows[1], int256(420104000000000000), 5e15);
...
//     */
//     assertGt(cashflows[3], 0, "3");
//     assertAlmostEq(cashflows[3], int(397099000000000000), 5e15);
...
//         vm.addr(1), // user
//         1001e18, // deposited margin
//         -(amounts[0].executedBaseAmount + amounts[1].executedBaseAmount),
//         -(amounts[0].executedQuoteAmount + amounts[1].executedQuoteAmount),
//         fee1,
//         1e18
//     );
...
//     // check individual CF is less thand expected with 0.3%
//   }
// }